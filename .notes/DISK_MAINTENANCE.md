...
launchctl unload ~/Library/LaunchAgents/com.richard.disk-monitor.plist

# Start monitoring service
launchctl load ~/Library/LaunchAgents/com.richard.disk-monitor.plist
...
Edit `/Users/richard/.dotfiles/bin/check-disk-space`:
