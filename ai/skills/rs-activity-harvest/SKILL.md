...
description: "Shared machinery for the cadence skills (rs-standup, rs-sprint-planning, and rs-quarterly-planning): the activity window, the GitHub and Slack harvest queries, and the archive-to-notes step. Load only when one of those skills points here; not useful standalone."
