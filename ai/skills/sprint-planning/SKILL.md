...
description: Write bi-weekly sprint planning updates for the LLM Analytics team. Automates PR fetching, sprint detection, and retro construction from the previous plan.
argument-hint: "archive|goals"
---

# Sprint Planning - LLM Analytics

Generate a bi-weekly sprint planning update for the LLM Analytics team, ready to post as a GitHub comment on the sprint planning issue.

## Team Configuration

**Team:** LLM Analytics
**GitHub Team:** `PostHog/team-llm-analytics`
**Project Board:** [PostHog Project 138](https://github.com/orgs/PostHog/projects/138)
**Goals Page:** [posthog.com/teams/llm-analytics#goals](https://posthog.com/teams/llm-analytics#goals)
...
```bash
gh api orgs/PostHog/teams/team-llm-analytics/members --jq '.[].login'
```
...
```markdown
## Team Goals - LLM Analytics

[Project Board](https://github.com/orgs/PostHog/projects/138)
